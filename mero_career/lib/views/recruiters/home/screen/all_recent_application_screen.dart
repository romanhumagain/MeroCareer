...
class AllRecentApplicationScreen extends StatefulWidget {
  const AllRecentApplicationScreen({super.key});

  @override
  State<AllRecentApplicationScreen> createState() =>
      _AllRecentApplicationScreenState();
}

class _AllRecentApplicationScreenState
    extends State<AllRecentApplicationScreen> {
  ...
  Future<void> getRecentApplication() async {
    await Provider.of<JobProvider>(context, listen: false)
        .getRecentApplicants(_listJobsBy);
  }
                    ...
                    Padding(
                      ...
                      child: Consumer<JobProvider>(
                        builder: (context, provider, child) {
                          ...
                          return Column(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: recentApplicants.map((data) {
